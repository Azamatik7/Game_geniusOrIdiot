namespace GeniusAndIdiotWinFormsApp
{
    public class QuestionsStorage
    {
        ...
        public List<Question> GetAll()
        {
            ...
            {
                GetDefaultQuestions();
                //throw new Exception("ќшибка брат");
            }
        ...
        public List<Question> GetDefaultQuestions()
        {
            ...
            Question default1 = new Question("—колько океанов на планете «емл€?", "4");
            Question default2 = new Question("ќдно €йцо варитс€ 3 минуты,сколько минут вар€тс€ три €йца?", "3");
            Question default3 = new Question("—колько будет два плюс два умножить на два?", "6");
            Question default4 = new Question("”кол делают каждые полчаса.—колько минут,сделать три укола?", "60");
            Question default5 = new Question("Ѕревно нужно распилить на 10 частей.—колько распилов нужно сделать?", "9");
